// meals.js - Database Initialization and Dummy Data Insertion

const sql = require("better-sqlite3");
const db = sql("meals.db"); // Connect to the "meals.db" SQLite database
...
// Insert dummy meal data into the "meals" table
